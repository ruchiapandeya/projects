	...
	<body>
		<section>
			<div class="buttons tiptip" style="height:129px; width: 860px; overflow-x: hidden;overflow-y: scroll;">
				...
				<button  class="button_large" onClick="showAdmin('invenio-book-correlation-surface')"><span class="label">Invenio Book Correlation Surface</span></button>
				<button  class="button_large" onClick="showAdmin('inv-book-vol-type-fixed')"><span class="label">Invenio Book Volume Type - Fixed</span></button>
				<button  class="button_large" onClick="showAdmin('inv-book-vol-type-floating')"><span class="label">Invenio Book Volume Type - Floating</span></button>
				<button  class="button_large" onClick="showAdmin('inv-book-vol-type-sel')"><span class="label">Invenio Book Volume Type - Selection</span></button>
