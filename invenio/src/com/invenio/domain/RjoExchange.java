 ...
 */
@Entity
@Table(name = "rjo_exchange")
public class RjoExchange implements java.io.Serializable {
	...
	public RjoExchange(Integer exchangeId) {
		this.exchangeId = exchangeId;
	}
	
	@Id
	@GeneratedValue(strategy = IDENTITY)
	@Column(name = "rjo_exchange_id", unique = true, nullable = false)
	...
	@Column(name = "rjo_exchange_name", nullable = false, length = 200)
	...
	@Column(name = "rjo_exchange_desc", nullable = true, length = 1000)
