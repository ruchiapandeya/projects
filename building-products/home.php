            ...
            <div class="result result1_top">
            	<div class="result1_bottom">
					<div class="cl_both result_top_padd ofh">
						<div class="fl_left result_left" style="color:#1c4974">
                        	<strong>Displaying</strong> <strong>1</strong> to <strong>4</strong></span> (of <strong>20</strong> Products)
                        </div>
						<div class="fl_right result_right" style="color:#1c4974">Result Pages: &nbsp;<b>1</b>&nbsp;&nbsp;
...
<script type="text/javascript">
	...
	<div style="background-image:url(images/menu_bar.png); height:20px; width:26.9%; margin-top:0%; padding:7px 0px 5px 5px;">
    	<a href="home.php" id="blueBar">BUILDING PRODUCTS</a>
    </div>
                 <div class="menus">
					<ul class="the_menu">
