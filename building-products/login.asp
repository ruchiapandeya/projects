...
<div class="wrapper_botttom"> 
	...
	<div class="row_3 ofh">  
		...
		<div id="bodyContent_login" > 
        	<p class="show">
            	<h5><a href="home.php">Home</a> > <a href="#">Log In</a></h5>
            </p>
			<h2 style="color:#c94812;">Welcome, Please Sign In</h2>
				...
				<div class="contentContainer ">
  					...
  					<div class="contentPadd loginPage">
						...
						<div style="width: 48%; float: left;">
							...
							<h4>New Member</h4>
								...
								<div class="logintext" style="position:relative; height:160px;">
								
                                	<p class="small_title"><strong>I am a new member.</strong></p>

 									<p>Curabitur a justo id elit gravida tincidunt ac sit amet elit. Fusce at sem lacus, vel luctus dolor.
                                    Curabitur a justo id elit gravida tincidunt ac sit amet elit. Fusce at sem lacus, vel luctus dolor. ...</p>
						
                        				<div class="buttonSet btn_position">       
                                        	<span><a href="registration.php"><img src="images/register.png" /></a></span>
  										</div>
						...
						<div style="width: 48%; float: right; border-left: 0px solid #e5e5e5;">

							<h6>Existing Member</h6>

								<div class="logintext" style="position:relative; height:160px;">

  									<p class="small_title"><strong>I am an existing member.</strong></p>

									<form name="login" action="#" method="post"><input type="hidden" name="" value="" />
										...
										<div class="buttonSet btn_position">                         
                                        	<span><a href="#"><img src="images/login.png" /></a></span>   
 									 	</div>

										<p class="forgotten"><a href="javascript:toggleForgotPassword()">Password forgotten? Click here.</a></p>
                    ...
                    <div id="forgotPasswordDiv" style="display: none">
                        <h2 style="color:#c94812;">I've Forgotten My Password!</h2>
        
                        <form name="" action="#" method=""><input type="hidden" name="formid" value="ccd110df00ac7781fb183f52f64eaf8e" />
                            ...
                            <div class="contentContainer">
                                ...
                                <div class="contentPadd">
                                    ...
                                    <div class="logintext">
                                        ...
                                        <div>If you've forgotten your password, enter your e-mail address below and we'll 
                                        send you an e-mail message containing your new password.
                                            ...
                                            <table border="0" width="100%" cellspacing="0" cellpadding="2">
                                                ...
                                                <tr>
                                                	...
                                                	<td class="fieldValue"><input type="text" name="" size="30"/></td>
                                                    
                            						<td><a href="#"><img src="images/submit.png" align="left" style="margin-left:-130%"/></a></td>
