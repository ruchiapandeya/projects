...
#top {
	width:255px;
	height:30px;
	background:url(images/top_bar1.png) no-repeat 0 0 #FFFFFF;
	color:#000000;
	float:left;
	margin-right:0px;
}
...
<form id="myform" name="form1" method="post" action="">
	<div id="list">
		<div style="width:300px;">
  			<input type="checkbox" onclick="javascript:parent.sendEmail('<?php echo $row[email];?>')" />
  &nbsp;&nbsp;&nbsp; <a href="" id="getEmail"> <img src="images/send_mail.png" border="none" title="Send Message to All" ></a>&nbsp;&nbsp;&nbsp; <a href="personal_folder.php"><img src="images/personal_folder.png" border="none" title="Personal Folders" ></a>&nbsp;&nbsp;&nbsp; <a href="add_new_records.php"> <img src="images/add_record.png" border="none" title="Add New Record" ></a>&nbsp;&nbsp;&nbsp;
  			<input type="image" src="images/remove.png" name="delete" id="delete" border="none" title="Remove Records" onClick="return toDelete();"/>
&nbsp;&nbsp; <a href="#" onClick="window.location.reload();return true;"> <img src="images/refresh.png" border="none" title="Refresh Records" ></a>&nbsp;&nbsp; <a href="bulkdata.php"> <img src="images/bulk.png" border="none" title="Bulk Uplaod" ></a>&nbsp;<a href="#"> <img src="images/excel.png" border="none" title="Excel Sheet" ></a>
  		</div>
		<div id="buttons">
			<ul id="list_align">
				<li class="listbox">
				...
				<li id="search_box">
					<form name="countrySearch" action="" method="get">
    					<input id="search2" class="search" type="text" name="keyword"  size="53" maxlength="255" value="<?php if($chkkeyword!=""){echo $chkkeyword;}else{echo "Keyword";}?>"  style="border:2px solid #FFCC66; font-size:14px;" />
					</form>
				</li>
			</ul>
		</div>
			...
			<div id="color">
    			<ul id="list_align">
      				<li style="margin-left:-10%;">
        				<input name="checkbox[]" type="checkbox" id="checkbox[]" value="<?php echo $row[id]; ?>"  style="margin-right:10%;" />
					</li>
					<li>
                    	<a href="javascript:parent.openLink('resume.php?id=<?php echo $row[id];?>')" id="keyword_align"><strong><?php echo $row[skills];?></strong></a>
					</li>
				</ul>
    			<br />
    			<p id="mid"  style="margin-left:2px;">
                	<font color="#FF9900" style="margin-top:-10px; font-size:14px; margin-left:42px"><strong><?php echo $row[name];?></strong></font> <font style="margin-top:-10px; font-size:12px; margin-left:12px"><strong>Title </strong> <font color="#FF9900">:</font> <?php echo $row[title];?></font><br />
      				<font style="margin-top:-10px; font-size:12px; margin-left:42px"><strong>Curr. Sal. </strong> <font color="#FF9900">:</font> <?php echo $row[curr_salary];?> <?php echo $row[curr_figure];?> (P.A)</font> | <font style="margin-top:-10px; font-size:12px; margin-left:2px"><strong>Exp. Sal. </strong> <font color="#FF9900">:</font> <?php echo $row[exp_salary];?> <?php echo $row[exp_figure];?> (P.A)</font><br />
					<font style="margin-top:-10px; font-size:12px; margin-left:42px"><strong>City </strong> <font color="#FF9900">:</font> <?php echo $row[city];?></font> | <font style="margin-top:-10px; font-size:12px; margin-left:2px"><strong>Country </strong> <font color="#FF9900">:</font> <?php echo $row[country];?></font><br />
					<font style="margin-top:-10px; font-size:12px; margin-left:42px"><strong>Email Id </strong> <font color="#FF9900">:</font> <?php echo $row[email];?></font> | <font style="margin-top:-10px; font-size:12px; margin-left:2px"><strong>Phone No. </strong> 				
                    <font color="#FF9900">:</font> <?php echo $row[phone1];?></font><br />
                    <font style="margin-top:-10px; font-size:12px; margin-left:42px"><strong>Job Type </strong> <font color="#FF9900">:</font></font> | <font style="margin-top:-10px; font-size:12px; margin-left:2px"><strong>Looking For </strong> 				
                    <font color="#FF9900">:</font> <?php echo $row[phone1];?></font><br />
                    <font style="margin-top:-10px; font-size:12px; margin-left:42px"><strong>Notice Period </strong> <font color="#FF9900">:</font></font> | <font style="margin-top:-10px; font-size:12px; margin-left:2px"><strong>Contract End Date </strong> 				
                    <font color="#FF9900">:</font> <?php echo $row[phone1];?></font><br />
                    <font style="margin-top:-10px; font-size:12px; margin-left:42px"><strong>Visa Status </strong> <font color="#FF9900">:</font></font> | <font style="margin-top:-10px; font-size:12px; margin-left:2px"><strong>End Client </strong> 				
                    <font color="#FF9900">:</font> <?php echo $row[phone1];?></font><br />
    			</p>
				<div id="view">
      				<ul>
        				<li><a href="javascript:parent.openLink('resume.php?id=<?php echo $row[id];?>')"><img src="images/view_resume.png" border="none"  title="View Resume" /></a> </li>
        				...
        				<li>
          				<?php
						$plus = 2;//total find keyword in each record
						//$minus = 50;
						//$totalnumber = $plus + $minus;
						$totalnumber = $countKeyword;//total searching keyword
						...
						echo '<div class="rating">
								<div class="graphcont"> '.$pluspercent.'% <div class="graph"><strong class="bar" style="width:'.$pluspercent.'%;">'.$pluspercent.'%</strong></div>
								</div>
							   </div>
							   <div class="clear"></div>';
						?>
				...
				<?php /*?><div id="addToFolderDiv<?php echo $row[id];?>">
        			<input type="radio" name="addToFolder" checked="checked" /><b>Existing Folder</b><br>
        			<form name="existingFolder" action="insert_folder.php" method="post">
            			...
            			<select name="existing_folder">
                			...
                			<?php 
							//$sqlFolder=mysql_query("select * from folders");
							//while($rowFolder=mysql_fetch_array($sqlFolder)){
							$sqlFolder=$dbUtil->query("select folderName from folders");
							foreach($sqlFolder as $rowFolder){
							?>
            				<option value="<?php echo $rowFolder[folderName];?>"><?php echo $rowFolder[folderName];?></option>
              				<?php }?>
            			</select><br>
            			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="submit" value="Add" onClick="saveAddToFolder(<?php echo $row[id];?>)">
       
            			<br />
                     </form>
					<form name="newFolder" action="insert_folder.php" method="post">
            			<input type="radio" name="addToFolder" /><b>New Folder</b><br>
            			<label>&nbsp;&nbsp;&nbsp;&nbsp; Folder Name</label>
            			<input type="hidden" name="id" value="<?php echo $row[id];?>" />
            			<input type="hidden" name="act" value="New" />
            			<input type="text" name="new_folder" style="margin-left:20px;" /><br>
            			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="submit" value="Add" onClick="saveAddToFolder(<?php echo $row[id];?>)">&nbsp;&nbsp;&nbsp;
                        <input type="button" value="Cancel" onClick="cancelAddToFolder(<?php echo $row[id];?>)">
       				</form>
        		</div><?php */?>
				<p id="date">Created Date: <?php echo $row['date'];?>	      &nbsp;&nbsp;||&nbsp;&nbsp;Last Updated:<?php echo $row['lastUpdated'];?></p>
			</div>
  		<?php }?>	
		</div>
	</div>
