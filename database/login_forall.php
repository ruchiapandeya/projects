...
if($user) {
	...
	@header('Location: iframe.php'); //Switching to next page
}else{
	LogUtil :: debug("successfully logged out!!");
}
...
<div id="contact_form">
  <form name="contact" method="post" action="check_login.php">
    <fieldset>
     
      <label for="email" id="email_label">User Name</label>
      <input type="text" name="loginEmail" id="email" size="30" value="" class="text-input" />
      
      <label for="password" id="password_label">Password</label>
      <input type="password" name="loginPassword" id="password" size="30" value="" class="text-input" />
      <label for="phone" id="password_error"><a href="forgotpassword.php">Forgot Password</a> || <a href="consultant_signup.php">SignUp Now</a></label>
      <br />
     <input type="image" src="images/login_admin.png" class="button" />
    </fieldset>
  </form>
