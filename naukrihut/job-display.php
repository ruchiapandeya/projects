...
<title>Job Display - Naukri Hut</title>
...
<p style="margin-right:145px;" align="right" ><a href="index.html"><img src="images/home_button.png"  style="margin-bottom:-5px; border:none;"/><strong> Home</strong></a></p>
        		...
        		<h2><?php echo $row[job_profile];?> -</h2>
        			<h4><?php echo $row[comp_name];?></h4>
        				...
        				<a href="#"><img src="images/registration.png" border="none" title="Apply without Registration"/></a>
                        		...
                        		<p><strong>Job Id:</strong><p id="displa"><?php echo "NH-".$row[id];?></p></p>
                        		<p><strong>No. of Opening:</strong><p id="displa"><?php echo $row[vacancy];?> Opening(s)</p></p>
                        		<p><strong>Work Experience:</strong><p id="displa"><?php echo "".$row[exp_min]."-".$row[exp_max]." Years";?></p></p>
                        		<p><strong>Job Location:</strong><p id="displa"><?php echo $row[location];?></p></p>
                        		<p><strong>Compensation:</strong><p id="displa"><?php echo "INR ".$row[sal_min]."-".$row[sal_min]."&nbsp;&nbsp;";?><?php if($row[incentive]!=""){?><br /><em style="padding-left:136px;">(<?php echo $row[incentive];?>)</em><?php }?></p></p>
                                <br />
                                <div id="second_box">
                                <p><strong>Educational Details:</strong><p id="displa"><?php echo "".$row[grad].", ".$row[pg]."";?></p></p>
                        		<p><strong>Industry:</strong><p id="displa"><?php 
										$industry =  highlightWords($row['industry'], $str1);
										echo $industry;
										?></p></p>
                                <p><strong>Job Type:</strong><p id="displa">Permanent</p></p>
                        		<p><strong>Roles Type:</strong><p id="displa"><?php 
										$role =  highlightWords($row['role'], $str1);
										echo $role;
										?></p></p>
                                <p><strong>Listed on:</strong><p id="displa"><?php echo $row[posted_date];?></p></p></div><br />
                                <p><strong>Functional Area:</strong><p id="displa"><?php 
										$functional_area =  highlightWords($row['functional_area'], $str1);
										echo $functional_area;
										?></p></p>
                                <p><strong>Keywords:</strong><p id="displa"><?php 
