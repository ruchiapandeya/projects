...
$query = mysql_query("SELECT email_ofc FROM employers WHERE email_ofc = '$email' LIMIT 1"); // Check if username exists in our database
...
//$check=1;
if($check=="0"){
	echo "<font color='#00CC00'>Already a member.</font>";
}
else{
