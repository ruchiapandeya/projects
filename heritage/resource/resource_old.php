		...
		<div id='main-area'>
			<div id='sidebar'>
				<div id='about-us'>
					...
					<br />
					<p>personal digital assistants (PDAs), servers, storage devices,
						displays, smartphones and peripherals. Although Acer has
						successfully made its own place between leading computer companies
						however, technical errors may occur on your laptop and</p>
				</div>
				<div id='events'>
					<div id='event-title'>
						<center>
					...
					<div class='event-list'>
						...
						<div class='description'>*Call for papers deadline has been
							extended to 17 September 2012</div>
						<div class='time'>27-28 October 2012</div>
					</div>
					<div class='event-list'>
						<div class='title'>
							<a href="http://indianoceanworldcentre.com/textiles2012" rel="tooltip" class="tip" data-placement="right"
					...
					<div class='event-list'>
						<div class='title'>
							<a href="http://indianoceanworldcentre.com/mcri_event02" rel="tooltip" class="tip" data-placement="right"
