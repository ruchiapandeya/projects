...
/** jquery.lavalamp.js ****************/
/**
 * LavaLamp - A nav plugin for jQuery with cool hover effects.
...
/**
 * Creates a nav with an unordered list of nav-items. You can either use the CSS that comes with the plugin, or write your own styles 
 * to create a personalized effect
 *
 * The HTML markup used to build the nav can be as simple as...
 *
 *       <ul class="lavaLamp">
 *           <li><a href="#">Home</a></li>
 ...
 *
 * Use the following snippet to initialize the nav.
 *   $(function() { $(".lavaLamp").lavaLamp({ fx: "backout", speed: 700}) });
 *
 * Thats it. Now you should have a working lavalamp nav. 
 *
 ...
 * @desc Creates a nav with "backout" easing effect. You need to include the easing plugin for this to work.
 *
 * @option speed - default is 500 ms
 * @example
 * $(".lavaLamp").lavaLamp({ speed: 500 });
 * @desc Creates a nav with an animation speed of 500 ms.
 *
 * @option click - no defaults
 * @example
 * $(".lavaLamp").lavaLamp({ click: function(event, menuItem) { return false; } });
 * @desc You can supply a callback to be executed when the nav item is clicked. 
 * The event object and the nav-item that was clicked will be passed in as arguments.
 */
(function($) {
